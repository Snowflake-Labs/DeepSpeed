...
class FP_Quantize(Quantizer):
    ...
    def quantize(self,
        ...
        if return_meta_tensor:
            ...
            if self.group_size == input.numel():
    ...
    def get_scales(self):
        return fp_quant_module.get_scales(self.scale, self.num_groups) if self.group_size != self.orig_shape.numel() else self.scale
